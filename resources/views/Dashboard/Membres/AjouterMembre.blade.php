    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-green-200">
            <div class="bg-gradient-to-r from-green-500 via-emerald-400 to-lime-400 px-8 py-6">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-2xl font-extrabold text-white">Informations de l'adhérent</h2>
                        <p class="text-green-100 font-medium">Remplissez tous les champs requis</p>
                    </div>
                </div>
            </div>

            <!-- Corps du formulaire -->
            <form action="{{ route('adherents.store') }}" method="POST" class="p-10 space-y-8">
        @csrf
        ...
        <div>
            ...
            <input type="password" name="password_hash_confirmation" id="password_hash_confirmation"
                ...
                <!-- Date d'inscription -->
        <div>
            <label for="date_inscription" class="block text-base font-bold text-green-700 mb-2">
                <div class="flex items-center gap-2">
                    <svg class="w-5 h-5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="relative">
                <input type="date" name="date_inscription_display" id="date_inscription"
                    ...
                    class="w-full px-4 py-3 border-2 border-green-200 rounded-2xl bg-green-50 text-green-600 cursor-not-allowed focus:outline-none">
            ...
            <p class="text-sm text-green-500 mt-2">La date d'inscription est automatiquement définie à aujourd'hui</p>
